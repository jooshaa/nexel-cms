...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Nexel product categories';
...
export interface ApiFeaturedSectionFeaturedSection
  ...
  attributes: {
    ...
    styleVariant: Schema.Attribute.Enumeration<
      ['grid', 'carousel', 'hero-split', 'list', 'spotlight']
    > &
...
export interface ApiHeroSlideHeroSlide extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    bgColor: Schema.Attribute.Media<'images'>;
...
export interface ApiNavbarSectionNavbarSection
  ...
  info: {
    description: 'Mega menu / navbar category sections';
  ...
  attributes: {
    ...
    promoLink: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
      }>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Nexel product catalog';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    heroProduct: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
